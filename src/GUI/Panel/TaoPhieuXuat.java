...
public final class TaoPhieuXuat extends JPanel {
    ...
    ButtonCustom btnAddSp, btnEditSP, btnDelete, btnImport, btnNhapHang, btnThemKhachHang;
    ...
    private void initComponent(String type) {
        ...
        btnThemKhachHang = new ButtonCustom("Thêm khách hàng!", "success", 14);
        btnThemKhachHang.setPreferredSize(new Dimension(200, 50)); // Chiều rộng 200, chiều cao 50
        ...
        right_top.add(btnThemKhachHang);
